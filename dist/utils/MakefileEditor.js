"use strict";var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault");require("core-js/modules/es.symbol.description"),require("core-js/modules/es.array.iterator"),require("core-js/modules/es.object.entries"),require("core-js/modules/es.string.replace"),require("core-js/modules/es.string.split"),Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=exports.MakefileEditor=void 0;var _defineProperty2=_interopRequireDefault(require("@babel/runtime/helpers/defineProperty")),_kebabCase=_interopRequireDefault(require("lodash/kebabCase")),_last=_interopRequireDefault(require("lodash/last")),_negate=_interopRequireDefault(require("lodash/negate")),_fsExtra=require("fs-extra"),_createJsonEditor=_interopRequireDefault(require("./createJsonEditor")),_createModuleEditor=_interopRequireDefault(require("./createModuleEditor")),_common=require("./common");const{assign,entries}=Object,{isArray}=Array,isNotArray=(0,_negate.default)(isArray),silent=()=>{},isLocalNpmCommand=(a,b=process.cwd())=>{const[c]=b.split("Makefile"),d=(0,_createJsonEditor.default)("package.json"),e=new d(c),f=e.hasAll(a),g=(0,_fsExtra.existsSync)(`${(0,_common.getBinDirectory)(b)}${a}`);return f||g};/**
 ...
 */class MakefileEditor extends(0,_createModuleEditor.default)("Makefile"){constructor(a=process.cwd()){super(a),(0,_defineProperty2.default)(this,"contents",""),(0,_defineProperty2.default)(this,"scripts",{}),(0,_defineProperty2.default)(this,"useBinVariable",!1)}write(a){const b=this,{fs:c,path:d,queue:e}=b;return e.add(()=>c.write(d,a)).then(()=>b.created=(0,_fsExtra.existsSync)(d)).catch(silent),assign(b,{contents:a})}/**
     ...
     */formatTask(a,b={}){var c,d,e;const{path:f}=this,g=a=>(0,_kebabCase.default)((0,_last.default)(a.split(" "))),h=(c=(d=(e=a,(b=>{const c=/['"]npm run .[^"]*['"]/g,d=a.match(c);return isNotArray(d)?b:d.reduce((a,b)=>a.replace(b,`'make ${g(b)}'`),b)})(e)),(c=>{const d=/npm .* -- --.*/g,e=a.match(d);return isNotArray(e)?c:e.reduce((a,c)=>{const[d,e]=c.split(" -- "),f=(0,_last.default)(d.split(" "));return a.replace(c,`${b[f]} ${e}`)},c)})(d)),(b=>{const c=/^npm run .*/g,d=a.match(c);return isNotArray(d)?b:d.reduce((a,b)=>a.replace(b,`$(MAKE) ${g(b)}`),b)})(c)),[i]=h.split(" "),j=isLocalNpmCommand(i,f);return this.useBinVariable=this.useBinVariable||j,`${j?`$(bin)`:""}${h}`}/**
     ...
     * //
     * @return {MakefileEditor} Chaining OK
     */addTaskDescription(a,b="Task description"){const c=this.contents.replace(`${(0,_kebabCase.default)(a)}:\n`,`${(0,_kebabCase.default)(a)}: ## ${b}\n`);return this.write(c)}appendHelpTask(){return this.addTask("help",["@fgrep -h \"##\" $(MAKEFILE_LIST) | fgrep -v fgrep | sed -e 's/\\$$//' | sed -e 's/##/\\n    /'"],{description:"Show this help"})}/**
