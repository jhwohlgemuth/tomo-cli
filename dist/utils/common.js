"use strict";var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault");require("core-js/modules/es.array.iterator"),require("core-js/modules/es.object.entries"),require("core-js/modules/es.promise"),require("core-js/modules/es.string.replace"),require("core-js/modules/es.string.split"),Object.defineProperty(exports,"__esModule",{value:!0}),exports.allDoNotExistSync=exports.allDoNotExist=exports.allDoExistSync=exports.allDoExist=exports.someDoExistSync=exports.someDoExist=exports.format=exports.getBinDirectory=exports.maybeApply=exports.parse=exports.dict=void 0;var _asyncToGenerator2=_interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator")),_path=require("path"),_isFunction=_interopRequireDefault(require("lodash/isFunction")),_fsExtra=require("fs-extra"),_prettier=_interopRequireDefault(require("prettier"));const PRETTIER_OPTIONS={bracketSpacing:!1,parser:"json-stringify",printWidth:150,tabWidth:4,singleQuote:!0},newMap=a=>new Map(a),joinPath=a=>(0,_path.join)(process.cwd(),a),checkPathExists=a=>{var b,c;return b=(c=a,joinPath(c)),(0,_fsExtra.pathExists)(b)},checkPathExistsSync=a=>{var b,c;return b=(c=a,joinPath(c)),(0,_fsExtra.pathExistsSync)(b)},dict=a=>{var b,c;return b=(c=a,Object.entries(c)),newMap(b)};exports.dict=dict;const parse=a=>{var b,c;return b=(c=a,JSON.stringify(c)),JSON.parse(b)};exports.parse=parse;const maybeApply=(a,b)=>(0,_isFunction.default)(a)?a(b):a;exports.maybeApply=maybeApply;const getBinDirectory=a=>{const[b]=a.split("Makefile");return`${b}node_modules/.bin/`};/**
