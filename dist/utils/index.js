 ...
 */exports.getVersions=getVersions;const showVersion=()=>{const a=join(__dirname,".."),{version:b}=read.sync({cwd:a});// eslint-disable-line no-console
