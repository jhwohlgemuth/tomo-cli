 ...
 */exports.getIntendedInput=getIntendedInput;const getProjectName=()=>{const{packageJson:a}=_readPkgUp.default.sync(),{name:b}=a||{name:"tomo-project"};return(0,_lodash.default)(b)};/**
 ...
 */exports.getProjectName=getProjectName;const getVersions=/*#__PURE__*/function(){var a=(0,_asyncToGenerator2.default)(function*(a=""){return 0===a.length?[]:(yield(0,_execa.default)("npm",["view",a,"versions"])).stdout.split(",\n").map(a=>a.match(/\d+[.]\d+[.]\d+/)).filter(isArray).map(_head2.default).map(_semver.default.valid).filter(Boolean)});return function(){return a.apply(this,arguments)}}();/**
 * Show version listed in package.json and exit
 * @return {string} Version
 */exports.getVersions=getVersions;const showVersion=()=>{const a=(0,_path.join)(__dirname,".."),{version:b}=_readPkg.default.sync({cwd:a});// eslint-disable-line no-console
