"use strict";var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault");require("core-js/modules/es.array.includes"),require("core-js/modules/es.array.iterator"),require("core-js/modules/es.string.split"),Object.defineProperty(exports,"__esModule",{value:!0}),exports.WebpackConfigEditor=exports.RollupConfigEditor=exports.PurgecssConfigEditor=exports.PostcssConfigEditor=exports.BsConfigJsonEditor=exports.PackageJsonEditor=exports.EslintConfigModuleEditor=exports.BabelConfigModuleEditor=exports.verifyRustInstallation=exports.uninstall=exports.install=exports.getVersions=exports.getIntendedInput=exports.choose=exports.withOptions=exports.isValidTask=exports.isUniqueTask=void 0;var _head2=_interopRequireDefault(require("ramda/src/head")),_asyncToGenerator2=_interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator")),_objectSpread2=_interopRequireDefault(require("@babel/runtime/helpers/objectSpread")),_has2=_interopRequireDefault(require("ramda/src/has")),_execa=_interopRequireDefault(require("execa")),_semver=_interopRequireDefault(require("semver")),_commonTags=require("common-tags"),_validateNpmPackageName=_interopRequireDefault(require("validate-npm-package-name")),_stringSimilarity=require("string-similarity"),_common=require("./common"),_createJsonEditor=_interopRequireDefault(require("./createJsonEditor")),_createModuleEditor=_interopRequireDefault(require("./createModuleEditor"));const{keys}=Object,{isArray}=Array,isUniqueTask=({text:a},b,c)=>c.map(({text:a})=>a).indexOf(a)===b;exports.isUniqueTask=isUniqueTask;const isValidTask=a=>(0,_has2.default)("text",a)&&(0,_has2.default)("task",a)&&"string"==typeof a.text&&"function"==typeof a.task;exports.isValidTask=isValidTask;const withOptions=a=>b=>(0,_objectSpread2.default)({},b,a);/**
